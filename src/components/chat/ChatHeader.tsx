...
const ChatHeader: React.FC<ChatHeaderProps> = ({ onMinimize, onClose }) => {
  return (
    <div className="bg-gradient-to-b from-indigo-600 to-indigo-500 text-white pt-4 pb-10 px-4 relative">
      ...
      {/* Wave shape */}
      <div className="absolute -bottom-1 left-0 right-0 w-full h-6 overflow-hidden z-10">
